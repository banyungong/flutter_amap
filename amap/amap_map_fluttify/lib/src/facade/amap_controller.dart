    ...
    return platform(
      android: (pool) async {
        ...
        for (var i = 0; i < attempts; i++) {
          ...
          final latitude = await location?.latitude;
          final longitude = await location?.longitude;
          if (latitude != null &&
              latitude != 0 &&
              longitude != null &&
              longitude != 0) {
      ...
      ios: (pool) async {
        for (var i = 0; i < attempts; i++) {
          ...
          final latitude = await coord?.latitude;
          final longitude = await coord?.longitude;
          if (latitude != null &&
              latitude != 0 &&
              longitude != null &&
              longitude != 0) {
