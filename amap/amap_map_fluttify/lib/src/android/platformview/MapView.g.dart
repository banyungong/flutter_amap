...
class com_amap_api_maps_MapView_AndroidView extends StatefulWidget {
  const com_amap_api_maps_MapView_AndroidView({
    Key? key,
    this.onViewCreated,
    this.onDispose,
  ...
  @override
  _com_amap_api_maps_MapView_AndroidViewState createState() => _com_amap_api_maps_MapView_AndroidViewState();
}

class _com_amap_api_maps_MapView_AndroidViewState extends State<com_amap_api_maps_MapView_AndroidView> {
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = com_amap_api_maps_MapView()..refId = 'com.amap.api.maps.MapView:$refId';
