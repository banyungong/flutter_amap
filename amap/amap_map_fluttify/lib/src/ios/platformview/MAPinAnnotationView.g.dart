...
class MAPinAnnotationView_UiKitView extends StatefulWidget {
  const MAPinAnnotationView_UiKitView({
    Key? key,
    this.onViewCreated,
    this.onDispose,
  ...
  @override
  _MAPinAnnotationView_UiKitViewState createState() => _MAPinAnnotationView_UiKitViewState();
}

class _MAPinAnnotationView_UiKitViewState extends State<MAPinAnnotationView_UiKitView> {
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = MAPinAnnotationView()..refId = 'MAPinAnnotationView:$refId';
