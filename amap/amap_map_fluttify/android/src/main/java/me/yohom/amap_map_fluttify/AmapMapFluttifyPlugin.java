...
public class AmapMapFluttifyPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        plugin.handlerMapList.add(SubHandler3.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler4.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler5.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler6.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler7.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler8.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler9.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler10.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler11.getSubHandler(messenger));
        plugin.handlerMapList.add(SubHandler12.getSubHandler(messenger));
